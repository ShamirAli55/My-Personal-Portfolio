...
const Hero = () => {
  ...
  return (
    <section className="container min-h-screen w-full flex items-start text-primary bg-background relative overflow-x-hidden font-sans md:font-[Funnel-Sans]">
      <div>
        <StarsBackground />
      </div>
      <div className=" h-full w-full relative">
        <h1 className="text-[5px] md:text-5xl font-bold pt-38 pb-18 md:px-28 capitalize leading-[45px] md:leading-[65px]">
          I craft seamless digital experiences{" "}
          <span className="inline-block text-center">
            while learning and growing every
          </span>
          day
        </h1>
        <h3 className="text-lg md:text-3xl font-bold md:px-28 pb-5">
          <span className="text-xl md:text-4xl hey mr-2 inline-block">👋</span>
